...
const NFT = ({ height, type, tier, zindex }) => {
  const src = {
    [ITEM_HAT]: {
    ...
    [ITEM_ROBE]: {
      ...
      [TIER_IV]: require('../../../../libs/design/assets/T3_ROBE.png'),
    },
    [ITEM_BOOK]: {
    ...
    [ITEM_STAFF]: {
      ...
      [TIER_IV]: require('../../../../libs/design/assets/T3_STAFF.png'),
    },
    [ITEM_CHEST]: {
  ...
  return <_nft src={img} alt={'NFT item'} $height={height} $zindex={zindex} />;
};
